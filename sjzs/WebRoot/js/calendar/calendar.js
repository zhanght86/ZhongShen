...
strFrame+=' BORDERCOLORLIGHT=#FF9900 BORDERCOLORDARK=#FFFFFF width=140 height=20 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '" title="在此处可按下鼠标左键可进行拖动">';
...
//身份证的验证
  ...
  {
	if (isNaN(num)) {alert("只能输入数字！"); return false;}
