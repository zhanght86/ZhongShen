...
//初始化table大小
  ...
  <body onload="javascript:init();">
		<form method="post" action="system/ffal!doUpdate.action" id="addForm" name="addJsdwForm">
		...
		<table class="table" id="list" style="font-size: 12px;margin-top: 10px"  align="center">
			<tr class="contentTd">
				...
				<td><label>
				  <input type="text" name="ffal.title" value="${ffal.title }"></input>
				</label></td>
				<td  align="right" width="170px;"><b>撰写人</b></td>
				<td><label>
				  <input type="text" name="ffal.author" value="${ffal.author }">
				</label></td>
			</tr>
			<tr class="contentTd">
				<td  align="right" width="170px;"><b>撰写单位</b></td>
				<td><label>
				  <input type="text" name="ffal.department" value="${ffal.department }">
				</label></td>
					<td  align="right" width="170px;"><b>获奖情况</b></td>
				<td><label>
				  <input type="text" name="ffal.awards" value="${ffal.awards }">
				</label></td>
			</tr>
			<tr class="contentTd">
				<td  align="right" colspan="1"><b>撰写日期</b></td>
				<td colspan="1" ><label>
				  <input id="date" maxLength="50" name="ffal.ffalDateTime" readonly="readonly" value="${ffal.ffalDateTime }" style="width:160px;"/>
				</label></td>
				...
				<td colspan="3">
				  ...
				  <textarea rows="7" cols="60"  name="ffal.content" id="matText">${ffal.content }</textarea>
				    <script type="text/javascript">
			...
			<tr  class="contentTd">
				...
				<tr class="contentTd">
					...
					<td align="left" style="padding-left:10px;" colspan="2">
						...
						<c:if test="${!empty ffal.attach.attachId}">
							<li id="${ffal.attachId }"> ${ffal.attach.attachName } 
							<img src="images/del.gif" onclick="javascript:deleteFile('${ffal.attachId }')" style="margin-left:20px;cursor:pointer;"/>
							</li>
						</c:if>
						</ul>
						<input type="hidden" name="ffal.attachId" id ="attachId" value="${ffal.attachId }"/>
					</td>
				</tr>
			<tfoot>
			<tr>
