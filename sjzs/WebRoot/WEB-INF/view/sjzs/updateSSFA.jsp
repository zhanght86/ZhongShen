...
//初始化table大小
  ...
  <body onload="javascript:init();">
		<form method="post" action="system/ssfa!updateSSFA.action" id="addForm" name="addJsdwForm">
		 <input type="hidden" name="shiShiFangAn.sort" value="${shiShiFangAn.sort }"/>
		 <input type="hidden" name="shiShiFangAn.id" value="${shiShiFangAn.id }"/>
		  <table class="table" id="list" style="font-size: 12px;margin-top: 10px"   height="100%" width="100%" align="center">
				<tr class="contentTd">
					...
					<td style="width: 170px">
						<label>
							<input type="text" name="shiShiFangAn.name" maxlength="50" value="${shiShiFangAn.name}">
						</label>
					</td>
					<td style="font-weight: bold; text-align: right;  width: 150px">
						<b>所属行业</b>
					...
					<td style="width: 170px">
						<label>
							<input type="text" name="shiShiFangAn.industry"  maxlength="50" value="${shiShiFangAn.industry}">
						</label>
					</td>
				</tr>
				<tr class="contentTd">
					...
					<td style="width: 170px">
						<label>
							<input type="text" name="shiShiFangAn.keyWord" maxlength="50" value="${shiShiFangAn.keyWord}" >
						</label>
					</td>
					<td style="font-weight: bold; text-align: right;  width: 150px">
						<b>撰写人</b>
					...
					<td style="width: 170px">
						<label>
							<input type="text" name="shiShiFangAn.author" maxlength="50" value="${shiShiFangAn.author}">
						</label>
					</td>
				</tr>
				<tr class="contentTd">
					...
					<td colspan="1" style="width: 170px">
						<label>
							<input id="date" maxLength="50"  name="shiShiFangAn.writeDate" readonly="readonly" value="${shiShiFangAn.writeDate}"
								style="width:160px;" />
						</label>
					</td>
					<td colspan="2">
			...
			<tr  class="contentTd">
					<td style="font-weight:bold; text-align:right; padding-right:10px;width: 50%" colspan="2">方案内容:</td>
				...
				<tr class="contentTd">
					<td style="font-weight:bold; text-align:right; padding-right:10px;width: 50%" colspan="2">
						附件列表:</td>
						<td align="left" style="padding-left:10px;" colspan="2">
						<ul id="fileList" style="margin-left: 5px;">
						<c:if test="${!empty shiShiFangAn.attach.attachId}">
							<li id="${shiShiFangAn.attachId }"> ${shiShiFangAn.attach.attachName } 
							<img src="images/del.gif" onclick="javascript:deleteFile('${shiShiFangAn.attachId }')" style="margin-left:20px;cursor:pointer;"/>
							</li>
						</c:if>
						</ul>
						<input type="hidden" name="shiShiFangAn.attachId" id ="attachId" value="${shiShiFangAn.attachId }"/>
					</td>
				</tr>
			<tfoot>
			<tr>
