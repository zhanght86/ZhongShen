...
//初始化table大小
  ...
  <body onload="javascript:init();">
		<form method="post" action="system/sjfg!doAddLaw.action" id="addLawForm" name="addJsdwForm">
		 <input type="hidden" name="law.lawSort" value="${law.lawSort }"/>
		  <table class="table" id="list" style="font-size: 12px;margin-top: 10px"  height="100%" width="100%"  align="center">
			<tr class="contentTd">
				...
				<td><label>
				  <input type="text" name="law.lawName">
				</label></td>
				<td  align="right" width="200px;"><b>发文单位</b></td>
				<td><label>
				  <input type="text" name="law.lawOrg">
				</label></td>
			</tr>
			<tr class="contentTd">
				<td  align="right" width="200px;"><b>法规日期</b></td>
				<td width="200px;">
				<input id="date" maxLength="50" name="law.lawDate" readonly="readonly" value="" style="width:130px;"/>
				...
				<td><label>
				  <input type="text" name="law.lawNumber">
				</label></td>
			</tr>
			<tr class="contentTd">
				...
				<td colspan="3">
				  ...
				  <textarea rows="5" cols="60"  name="law.lawContent" id="matText"></textarea>
				    <script type="text/javascript">
			...
			<tr  class="contentTd">
				...
				<tr class="contentTd">
					...
					<td align="left" style="padding-left:10px;" colspan="2">
						...
						<input type="hidden" name="law.attachId" id ="attachId" value=""/>
					</td>
				</tr>
			<tfoot>
			<tr>
  ...
  <script type="text/javascript">
	...
	function selectFile() {			
		var width = "920";
		var url = "<%=basePath%>attach!selectFile.action?attach.attachId=${attach.attachId}&nocache=" + new Date().getTime();
