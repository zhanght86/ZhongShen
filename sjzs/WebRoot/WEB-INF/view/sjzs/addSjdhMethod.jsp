	...
	<script type="text/javascript">
	 $(function(){
		...
		function submitMenuCheck() {
			...
			result = promptMsg(textCheck('methodTime',1,200), '*必填','info2') && result;
			return result;
		}
...
<body>
<div class="pageContent"><%--onsubmit="return submitMenuCheck();" --%>
	<form name="form1" action="system/sjdh!doAddInfo.action" method="post" id="addForm" onsubmit="return submitMenuCheck();">
	<input name="sjdhMethod.typeNo" type="hidden" value="${sjdhMethod.typeNo }"/>
	<input name="sjdhMethod.template_no" type="hidden" value="0"/>
	      	...
	      	<table width="99%" border="0" cellspacing="0" cellpadding="0" class="">
		        <tr>
		          ...
		          <td width="39%" align="left">
						<input name="sjdhMethod.name" type="text" value="" id="methodName"/>
		          ...
		          <input name="sjdhMethod.orderNum" type="text" value="" id="methodOrder" onkeyup="value=value.replace(/[^\d]/g,'')" 
		          	 onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"/>
		          	 <span id="info2"><font color="red">*必填</font></span>
		          	 <%--
		          	 <em><font color="red">*必填</font></em>
		          	  --%>
                  </td>
		        ...
		        <tr>
		          ...
		          <td width="39%" align="left" >
						<textarea name="sjdhMethod.context" style="widht:50%;height:50px"></textarea>
				  </td>
		          <td width="14%" align="right">&nbsp;</td>
		          <td width="34%" align="left">
		          	&nbsp;
		          ...
		          <td align="center" colspan="4">
		          	<div class="formBar">
						<ul>
							...
							<li>
								<div class="button"><div class="buttonContent"><button type="button" class="close" onclick="javascript:window.close();">取消</button></div></div>
							</li>
						</ul>
					</div>
		          </td>
