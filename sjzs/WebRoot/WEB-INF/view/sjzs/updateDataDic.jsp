...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body onload="javascript:init();" style="margin-top:10px;">
	...
	<form action="system/dataDic!updateDataDic.action" method="post" id="addForm" id="addForm">
		<input type="hidden" value="${dataDicDto.dicId }" name="dataDicDto.dicId"/>
		<input type="hidden" value="${dataDicDto.dicParentId }" name="dataDicDto.dicParentId"/>
		<table cellpadding="0" cellspacing="0" border="1"  id="add" class="table2">
			<caption>审计事项修改</caption>
			<tr class="contentTd">
				...
				<td style=" font-weight:bold; text-align:left; padding-left:10px;">
					<input type="text"  name="dataDicDto.dicName" value="${ dataDicDto.dicName}" maxlength="50"/>
				</td>
			</tr>
				<tr class="contentTd">
				...
				<td style=" font-weight:bold; text-align:left; padding-left:10px;">
					<input name="dataDicDto.industry" value="${dataDicDto.industry}"></input>
				</td>
			</tr>
			<tr class="contentTd">
				...
				<td style="text-align:left; padding-left:10px;">
					<input type="text" value="${dataDicDto.dicOrder}" name="dataDicDto.dicOrder" onkeyup="value=value.replace(/[^\d]/g,'')" 
			...
			<tr class="contentTd">
				...
				<td style=" font-weight:bold; text-align:left; padding-left:10px;">
					<textarea name="dataDicDto.dicMemo" style="width: 100%;height: 150px;">${dataDicDto.dicMemo}</textarea>
				</td>
			</tr>
			<tr class="bottomTd" height="27" align="center">
				<td colspan="2">
					<input type="submit" value="&nbsp;" id="savebtn" class="modifybtn"/>&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
			</tr>
		</table>
	</form>
