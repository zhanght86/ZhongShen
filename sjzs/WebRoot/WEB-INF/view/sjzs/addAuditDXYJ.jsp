 ...
 <style type="text/css">
  ...
  <body id="all" onload="javascript:init();">
  	...
  	<div class="w_list_print">
		<form method="post" action="system/dxyj!doAddAuditDXYJ.action" id="addLawForm" class="pageFormContent" >
		 ...
		 <input type="hidden" name="law.nodeType" value="1"/>
				 ...
				 --%><tbody>
					<tr class="contentTd"  >
						...
						<td class="comm"><input type="text" name="law.caption"></td>			
						<td  align="right" colspan="2" class="comm"><b>发文单位:&nbsp;</b></td>
						<td colspan="2" class="comm"><input type="text" name="law.department">
						</td>
					</tr>
					<tr class="contentTd">
						<td  align="right" class="fir"><b>发文编号:&nbsp;</b></td>
						<td><input type="text" name="law.lawNo"></td>
					
						<td  align="right" class="spec" ><b>条:&nbsp; </b>
						</td>
						<td class="spec" ><input type="text" name="law.tiao" size="7" onkeyup="value=value.replace(/[^\d]/g,'')" 
		          	 onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
						</td>			
						<td  align="right" width="80px" ><b>款:&nbsp;</b>
						</td>
						<td  width="100px"><input align="left" type="text" name="law.kuan" size="7" onkeyup="value=value.replace(/[^\d]/g,'')" 
		          	 onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
						</td>
					</tr>
					<tr>
						<td class="fir" align="right" style="line-height:100%"><b>创建日期：</b></td>
						<td colspan="5">
							<input id="date" maxLength="50" name="law.writeDate" readonly="readonly" value="" style="width:160px;" onClick="setday(this,document.all.date)" />
					<img style="CURSOR: hand" onClick="setday(this,document.all.date)" src="js/calendar/form/calendar.gif" align="middle" border="0" width="30" height="30"/>
						</td>
					...
					<tr class="contentTd">
						...
						<div class="unit">
									<textarea class="editor" name="law.lawContent" id="matText" rows="7" cols="60" tools="mfull"></textarea>
								  <script type="text/javascript">
					...
					<tr>
					   ...
					   <input type="button" value=" " id="closebtn" class="closebtn" onclick="closeWin();">
							<%--<dl class="nowrap" >
								<dd style="margin-left:300px;width:100px;"><div class="buttonActive"><div class="buttonContent"><button type="submit" >添加</button></div></div></dd>
							</dl>				
						--%></td>
					</tr>
					</tfoot>
