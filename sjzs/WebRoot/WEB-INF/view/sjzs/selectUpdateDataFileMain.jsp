			...
			function createPanel(){	  
				var panel = new Ext.TabPanel({
		            	...
		            	pageX:500,
		           		pageY:200, 
		            	items:[
							new Ext.Panel({title:"从本地上传",height:30,html:'<iframe frameborder="0" scrolling="auto" width="100%" height="100%" src="attach!updateDateUpFilePage.action?&type=${type}"></iframe>'})
		                ]
		      	});         
		     	panel.render("panel");
				panel.activate(0);	 
