/*
 * @项目名称: htglxt
 * @文件名称: ShowSignetServlet.java
 * @日期: 2012-3-1 下午05:17:52  
 * @版权: 2011 河南中审科技有限公司
...
/**    
 * 项目名称：htglxt   <br/>
 * 类名称：ShowSignetServlet.java   <br/>
 * 类描述：   <br/>
 * 创建人：王亲臣   <br/>
 * 创建时间：2012-3-1 下午05:17:52   <br/>
 * 修改人：王亲臣   <br/>
 * 修改时间：2012-3-1 下午05:17:52   <br/>
 * 修改备注：    <br/>
 * @version  1.0  
 */
@SuppressWarnings("serial")
public class ShowSignetServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		sql.append("SELECT SIGNET FROM employee WHERE UID = ?");
